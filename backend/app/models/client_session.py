...
class ClientSession(Base):
    ...
    client_member_id: Mapped[uuid.UUID | None] = mapped_column(UUID(as_uuid=True), ForeignKey("client_members.id", ondelete="SET NULL"), nullable=True, index=True)
    ...
    client_member = relationship("ClientMember")
